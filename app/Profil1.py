...
st.markdown("""
Après analyse approfondie, **Rushoar** se distingue comme le Pal offrant les meilleures caractéristiques pour ce poste.  
Bien qu’il ne garantisse pas un rendement optimal à long terme, il répond parfaitement à l’ensemble des exigences définies pour cette phase initiale.  
Sa compatibilité avec les critères du poste en fait un choix fiable et pertinent pour cette première étape.
""")
